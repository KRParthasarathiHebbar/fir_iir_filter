...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin)
{
	UNUSED(GPIO_Pin);
	flag=1;
	//FIRFilter_Update(&lpfAcc, myData.x);
	IIRFilter_Update(&hpfAcc, myData.x);
	//float output=lpfAcc.out;
...
int main(void)
{
  ...
  IIRFilter_Init(&hpfAcc, IIRFilter_ALPHA);
  /* USER CODE END Init */
